        ...
        try {
            ...
            if (simpleQueryForBlobMemoryFile != null) {
                try {
                    ...
                    String str2 = "SQLiteContentHelper";
                ...
                AssetFileDescriptor assetFileDescriptor = new AssetFileDescriptor(parcelFileDescriptor, 0, (long) simpleQueryForBlobMemoryFile.length());
